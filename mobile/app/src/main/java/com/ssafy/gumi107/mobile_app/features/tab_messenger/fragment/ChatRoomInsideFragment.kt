...
class ChatRoomInsideFragment : BaseFragment<FragmentChatRoomInsideBinding>(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        initView(chatRoom)
        gobackToChatRoomOutside() //뒤로가기 버튼 처리
    }
    ...
    private fun gobackToChatRoomOutside(){
        binding.inmessageroomBack.setOnClickListener {
            val action = ChatRoomInsideFragmentDirections.actionChatRoomInsideFragmentToTabMessage()
